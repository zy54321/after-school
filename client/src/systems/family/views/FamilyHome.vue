  ...
  <div class="landing-page">
    <header class="navbar">
      <div class="logo">
        ...
        <span class="text">{{ $t('family.home.title') }}</span>
      </div>
    ...
    <main class="hero-section">
      ...
      <div class="hero-content">
        <div class="hero-badge">
          ...
          <span>{{ $t('family.home.title') }}</span>
        </div>
        <h1 class="slogan">{{ $t('family.home.slogan') }}</h1>
        <p class="sub-slogan">{{ $t('family.home.subSlogan') }}</p>
        ...
        <div class="hero-stats">
          <div class="stat-item">
            ...
            <div class="stat-label">{{ $t('family.home.stats.stat1') }}</div>
          </div>
          <div class="stat-item">
    ...
    <section class="intro-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">{{ $t('family.home.intro.title') }}</h2>
          <p class="section-desc">{{ $t('family.home.intro.desc') }}</p>
        </div>
        <div class="highlights-grid">
          <div class="highlight-card card-1">
            ...
            <h3>{{ $t('family.home.intro.highlight1') }}</h3>
            <p>{{ $t('family.home.intro.highlight1Desc') }}</p>
          </div>
          <div class="highlight-card card-2">
            <div class="card-icon-wrapper">
              <div class="highlight-icon">🎯</div>
            </div>
            <h3>{{ $t('family.home.intro.highlight2') }}</h3>
            <p>{{ $t('family.home.intro.highlight2Desc') }}</p>
          </div>
          <div class="highlight-card card-3">
            <div class="card-icon-wrapper">
              <div class="highlight-icon">📊</div>
            </div>
            <h3>{{ $t('family.home.intro.highlight3') }}</h3>
            <p>{{ $t('family.home.intro.highlight3Desc') }}</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <h3>{{ $t('family.home.features.taskTitle') }}</h3>
            <p>{{ $t('family.home.features.taskDesc') }}</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <div class="feature-icon">🎁</div>
            </div>
            <h3>{{ $t('family.home.features.rewardTitle') }}</h3>
            <p>{{ $t('family.home.features.rewardDesc') }}</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <div class="feature-icon">📈</div>
            </div>
            <h3>{{ $t('family.home.features.logTitle') }}</h3>
            <p>{{ $t('family.home.features.logDesc') }}</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <div class="feature-icon">📅</div>
            </div>
            <h3>{{ $t('family.home.features.calendarTitle') }}</h3>
            <p>{{ $t('family.home.features.calendarDesc') }}</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <div class="feature-icon">🎨</div>
            </div>
            <h3>{{ $t('family.home.features.configTitle') }}</h3>
            <p>{{ $t('family.home.features.configDesc') }}</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <div class="feature-icon">👨‍👩‍👧</div>
            </div>
            <h3>{{ $t('family.home.features.memberTitle') }}</h3>
            <p>{{ $t('family.home.features.memberDesc') }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="use-cases-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">{{ $t('family.home.useCases.title') }}</h2>
        </div>
        <div class="use-cases-list">
          <div class="use-case-item">
            <div class="use-case-icon">✨</div>
            <div class="use-case-content">
              <h3>{{ $t('family.home.useCases.case1.title') }}</h3>
              <p>{{ $t('family.home.useCases.case1.desc') }}</p>
            </div>
          </div>
          <div class="use-case-item">
            <div class="use-case-icon">🔧</div>
            <div class="use-case-content">
              <h3>{{ $t('family.home.useCases.case2.title') }}</h3>
              <p>{{ $t('family.home.useCases.case2.desc') }}</p>
            </div>
          </div>
          <div class="use-case-item">
            <div class="use-case-icon">📚</div>
            <div class="use-case-content">
              <h3>{{ $t('family.home.useCases.case3.title') }}</h3>
              <p>{{ $t('family.home.useCases.case3.desc') }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="advantages-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">{{ $t('family.home.advantages.title') }}</h2>
        </div>
        <div class="advantages-list">
          <div class="advantage-item">
            <div class="advantage-number">01</div>
            <div class="advantage-content">
              <h3>{{ $t('family.home.advantages.adv1.title') }}</h3>
              <p>{{ $t('family.home.advantages.adv1.desc') }}</p>
            </div>
          </div>
          <div class="advantage-item">
            <div class="advantage-number">02</div>
            <div class="advantage-content">
              <h3>{{ $t('family.home.advantages.adv2.title') }}</h3>
              <p>{{ $t('family.home.advantages.adv2.desc') }}</p>
            </div>
          </div>
          <div class="advantage-item">
            <div class="advantage-number">03</div>
            <div class="advantage-content">
              <h3>{{ $t('family.home.advantages.adv3.title') }}</h3>
              <p>{{ $t('family.home.advantages.adv3.desc') }}</p>
            </div>
          </div>
        </div>
      </div>
